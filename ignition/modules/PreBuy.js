...
module.exports = buildModule("PreBuyModule", (m) => {
  ...
  return { factory, prebuy };
});

// npx hardhat ignition deploy ignition/modules/PreBuy.js --network base --deployment-id prebuy-base-one